      ...
      <div className="flex md:flex-row flex-col justify-center items-center md:items-start gap-6">
        ...
        <div>
          ...
          <div className="flex flex-row gap-4 mt-5">
            <button className="text-gray-900 px-4 py-2 rounded-full font-medium text-sm shadow-md bg-primary whitespace-nowrap cursor-pointer transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
